    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="line"></div>
			     ...
			     <div class="container">
        <div class="row">
        <form class="col-12 col-sm-12 col-md-12 col-lg-12" id="contact-form" method="post" action="/cars" role="form" enctype='multipart/form-data'>
			 {{csrf_field()}}
...
<div class="controls">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="make" type="text" name="make" class="form-control" placeholder="eg... Toyota*" required="required" data-error="Make is required.">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="model" type="text" name="model" class="form-control" placeholder="eg... Hilux *" required="required" data-error="Model is required.">
                <div class="help-block with-errors"></div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="year" type="number" name="year" min=1800 max=2100 class="form-control" placeholder="eg...2017 *" required="required" data-error="Make is required.">
                <div class="help-block with-errors"></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="milleage" type="number" min=0 name="milleage" class="form-control" placeholder="eg...Odometer reading *" required="required" data-error="Model is required.">
                <div class="help-block with-errors"></div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea id="form_message" name="description" class="form-control" placeholder="Brief Vehicle description *" rows="4" required="required" data-error="Please, leave us a message."></textarea>
                <div class="help-block with-errors"></div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="engine" type="text" name="engine" class="form-control" placeholder="eg...4.4L *" required="required" data-error="Make is required.">
                <div class="help-block with-errors"></div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <label class="custom-file-label" for="validatedCustomFile">Choose Image...</label>
		...
		<div class="col-md-3">
	<div class="custom-file">
    <input type="file" class="custom-file-input" name="image2" id="validatedCustomFile1" required>
    <label class="custom-file-label" for="validatedCustomFile1">Choose Image...</label>
		...
		<div class="col-md-3">
	<div class="custom-file">
    <input type="file" class="custom-file-input" name="image3" id="validatedCustomFile2" required>
    <label class="custom-file-label" for="validatedCustomFile2">Choose Image...</label>
		...
		<div class="col-md-3">
	<div class="custom-file">
    <input type="file" class="custom-file-input" name="image4" id="validatedCustomFile3" required>
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted">
		        ...
		        <div class="col-md-12">
            <input style="background-color:grey;color:white" type="submit" class="btn btn-lg btn-send" value="Upload Vehicle">
        </div>
    </div>
</div>
